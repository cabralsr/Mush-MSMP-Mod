...
public class RastejadorEntity extends Monster implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public RastejadorEntity(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    public void die(DamageSource cause) {
        ...
        if (!this.level().isClientSide()) {
            ...
            net.minecraft.resources.ResourceLocation soundId = ModSounds.RASTEJADOR_AMBIENT.getId();
