...
public class mobEntity extends PathfinderMob implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public mobEntity(EntityType<? extends PathfinderMob> type, Level level) {
        super(type, level);
    }
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide) {
            ...
            if (!this.hasEffect(MobEffects.DAMAGE_RESISTANCE)) {
                ...
                this.addEffect(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, Integer.MAX_VALUE, 4, false, false));
            }
        }
    }
