...
public class DogZombieEntity extends Monster implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public DogZombieEntity(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    protected SoundEvent getAmbientSound() {
        return ModSounds.DOGZOMBIE_AMBIENT.get();
    }
    ...
    public void die(DamageSource cause) {
        ...
        if (!this.level().isClientSide()) {
            ...
            net.minecraft.resources.ResourceLocation soundId = ModSounds.DOGZOMBIE_AMBIENT.getId();
